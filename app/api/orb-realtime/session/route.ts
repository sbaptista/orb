...
export async function POST(request: Request) {
  ...
  const session = {
    ...
    instructions: [
      ...
      'FORMAT: you are speaking, not writing. You cannot render a table, and saying you will \"read it as a table\" is a claim you cannot keep — it comes out as a list either way. If the user asks for a table, say plainly that voice reads results aloud and offer to list them or to have them typed in the text conversation, then read the fields in a consistent order so the shape is still followable.',
