...
- **2026-07-28 20:55** *(refreshed; 3.1 + 3.2 committed, continuing)*
  Surface: ORB-361 Phase 3 — 3.1 per-project urgency windows **done (v0.6.247–248)**, 3.2 Help overhaul **done (v0.6.249)**; next 3.3 mood explanation, 3.4 no-reminder nudge
