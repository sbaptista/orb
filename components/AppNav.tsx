...
import OrbVersionLabel from './ui/OrbVersionLabel'
...
export default function AppNav({ printContext, userInitial = '?', userName, orbToggle, listToggle }: Props) {
  ...
  return (
    <>
      <nav className="appnav" aria-label="Global navigation">
        <div className="appnav-side appnav-side--left">
        ...
        <div className="appnav-group" data-tour="global-nav">
          {onSettings ? (
            <span className="appnav-btn appnav-current" aria-current="page">
              <span className="appnav-btn-icon">{IconSettings}</span>
              <span className="appnav-btn-label">Settings</span>
            </span>
          ) : (
            <Link href="/settings" className="appnav-btn" data-tooltip="Settings" aria-label="Settings">
              <span className="appnav-btn-icon">{IconSettings}</span>
              <span className="appnav-btn-label">Settings</span>
            </Link>
          )}
      ...
      {showPrint && (
        <PrintModal
          ...
          selectedProductId={printContext?.productId ?? null}
          selectedProductName={printContext?.productName ?? null}
        />
      )}
      ...
      {commandsOpen && (
        <div className="modal-overlay" onClick={() => setCommandsOpen(false)}>
          ...
          >
            ...
            <div className="ud-commands-version">
              <OrbVersionLabel />
            </div>
          </div>
        </div>
