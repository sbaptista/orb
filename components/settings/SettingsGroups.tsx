    ...
    <div className="p-6 max-w-2xl">
      ...
      <div className="bg-white rounded-lg border border-zinc-200 overflow-hidden">
        ...
        {displayed.length === 0 && !showAdd ? (
          <p className="text-sm text-zinc-400 px-4 py-8 text-center">No groups in this scope.</p>
        ) : (
          <div className="divide-y divide-zinc-100">
            {displayed.map(g =>
              editingId === g.id ? (
                ...
                <div key={g.id} className="flex items-center gap-3 px-4 py-3 hover:bg-zinc-50">
                  <div className="flex-1 min-w-0">
                    <p className="text-sm text-zinc-800">{g.name}</p>
                    <p className="text-xs text-zinc-400">sort: {g.sort_order}</p>
                  </div>
